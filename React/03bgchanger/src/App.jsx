...
function App() {
  ...
  return (
    <>
    <div className= 'w-full h-screen duration-300 bg-black' style={{backgroundColor: color}}> 
...
<button className='outline-none px-4 py-1 rounded-full  shadow-lg text-black'> test3</button>
